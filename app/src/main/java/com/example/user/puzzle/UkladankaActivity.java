...
public class UkladankaActivity extends AppCompatActivity {

    private static DetectGrid mGridView;
    ...
    private void init() {
        mGridView = (DetectGrid) findViewById(R.id.grid);
    ...
    private static void display(Context context) {
        ...
        mGridView.setAdapter(new Adapter(buttons, mColumnWidth, mColumnHeight));
    }
